        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1 space-y-6">
            ...
            <p className="text-gray-500 text-sm">
              The premier platform for finding software engineering internships. Connect with top
              companies and kickstart your career.
            </p>
          ...
          <div className="col-span-1">
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Job Categories</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/jobs?category=software-engineering"
                  className="text-sm text-gray-500 hover:text-indigo-600 transition-colors"
                >
              ...
              <li>
                <Link
                  href="/jobs?category=machine-learning"
                  className="text-sm text-gray-500 hover:text-indigo-600 transition-colors"
                >
                  Machine Learning
                </Link>
